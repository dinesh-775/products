...
function Products() {
  const products = [
    ...
    },
    {
      ...
      image: "https://images.samsung.com/in/galaxy-watch6-classic/feature/galaxy-watch6-classic-banner-watch6-mo.jpg",
    },
    {
      productId: 3,
      name: "MX Master 3S",
      ...
      image: "https://m.media-amazon.com/images/I/618IJzC-fFL._AC_UF1000,1000_QL80_.jpg",
    },
    {
      productId: 4,
      name: "MacBook Air M3",
      ...
      image: "https://www.macworld.com/wp-content/uploads/2024/03/macbook-air-m3-2.jpg?quality=50&strip=all",
    },
    {
      productId: 5,
      ...
      image: "https://headphonesaddict.com/wp-content/uploads/2023/09/Sony-WH-1000XM5-in-a-table.jpg",
    },
    {
      productId: 6,
      name: "iPad Mini 6",
      ...
      image: "https://akm-img-a-in.tosshub.com/indiatoday/images/story/202108/iPad_mini_6.jpg?size=690:388",
    },
    {
      productId: 7,
      ...
      image: "https://m.media-amazon.com/images/I/61x3nRatR9L._AC_UF1000,1000_QL80_.jpg",
    },
    {
      productId: 8,
      ...
      image: "https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/peripherals/monitors/u-series/u2724de/media-gallery/monitor-ultrasharp-u2724de-gy-gallery-1.psd?fmt=pjpg&pscan=auto&scl=1&wid=5000&hei=5000&qlt=100,1&resMode=sharp2&size=5000,5000&chrss=full&imwidth=5000",
    },
    {
      productId: 9,
      name: "Pixel 8 Pro",
    ...
    },
    {
      ...
      image: "https://varietyinfotech.com/wp-content/uploads/2025/07/Samsung-Portable-T9-USB-3.2-Gen2x2-2TB-SSD-Black-5.jpg",
    },
  ];
    ...
    <div className="grid gap-7 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
      {products.map((product) => (
        <Product
          ...
          product={product}
          className="shadow-[0_0_20px_rgba(34,211,238,0.35)] hover:shadow-[0_0_45px_rgba(34,211,238,0.9)]"
        />
      ))}
    </div>
  );
